...
// ===========================
const char *ssid = "HOME24";
const char *password = "bndndbn1978";
...
void setup() {
  ...
  config.frame_size = FRAMESIZE_SVGA;// FRAMESIZE_CIF;//FRAMESIZE_240X240;//FRAMESIZE_96X96;//FRAMESIZE_UXGA;
  //PIXFORMAT_GRAYSCALE;//
  ...
  s->set_aec_value(s, 160); // aec_value = 108
...
// Setup LED FLash if LED pin is defined in camera_pins.h
  ...
  //sensor_t *s = esp_camera_sensor_get();
  //sys_mul = 180;
  //ret = set_pll(s, false, sys_mul, 4, 2, false, 2, true, 4);
}
